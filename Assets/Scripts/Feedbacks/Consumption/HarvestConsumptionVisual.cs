...
public class HarvestConsumptionVisual : MonoBehaviour
{
    [Header("Components")]
    ...
    {
        citizen.OnHarvestConsumption += Citizen_OnHarvestConsumption;
    }
    ...
    private void Citizen_OnHarvestConsumption(object sender, Citizen.OnCitizenConsumptionEventArgs e)
    {
